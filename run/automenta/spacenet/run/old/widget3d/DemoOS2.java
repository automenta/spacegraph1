 ...
 */
package automenta.spacenet.run.old.widget3d;

import automenta.spacenet.run.old.os.OSRootMenu;
 ...
 */
public class DemoOS2 extends ProcessBox {
    ...
    public class DemoGraphBox extends Box {
        ...
        public DemoGraphBox() {
...

            {
                ...
                attentionControlWin.move(0, 0.5, 0).scale(0.2, 0.15);
            }
            ...
            add(new OSRootMenu(tg)).move(1, 0, 0);
        ...
        return new GraphBoxBuilder() {
            ...
            public Box newNodeSpace(Object vertex) {
                ...
                if (label.length() > maxLabelSize) {
                    label = label.substring(0, maxLabelSize-1);
                }
                Dialog3D d = new Dialog3D(font3d, label, 0.5, 0.5, 0.05);
                //FacesCameraBox fcb = new FacesCameraBox(d);
                phySpace.add(new PhyBox(d, 1.0f));
                return d;
            }
...
//        };
    ...
    public static void main(String[] argV) {
        ArdorSpacetime.newWindow(new DemoOS2().scale(4));
    }
}
