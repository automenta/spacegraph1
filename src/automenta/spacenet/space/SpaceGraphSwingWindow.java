...
/**
 * a swing window that presents/browses at a SpaceGraph node
 * @see com.ardor3d.example.pipeline.ScenegraphTree.java
 */
public class SpaceGraphSwingWindow {
    ...
    public SpaceGraphSwingWindow(Node node) {
        super();
        this.node = node;

        final JFrame frame = new JFrame("Space Graph: " + node.getName());
